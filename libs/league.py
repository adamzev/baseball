...
class League(object):
    def __init__(self):
        ...
        print("H: {} H2B: {} H3B: {}, HR: {} sac_bunt: {} sac_fly: {} GO: {} \
            AO: {} GDP: {} BB: {}".format(H, H2B, H3B, HR, sac_bunt, sac_fly,
             GO, AO, GDP, BB))
        print("H: {} H2B: {} H3B: {}, HR: {} sac_bunt: {} sac_fly: {} GO: {} AO: \
            {} GDP: {}, BB: {}".format(H / TPA, H2B / TPA, H3B / TPA, HR / TPA,
            sac_bunt / TPA, sac_fly / TPA, GO / TPA, AO / TPA, GDP / TPA, BB / TPA))
